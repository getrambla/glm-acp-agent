...
export const TOOL_DEFINITIONS = [
    {
        ...
        function: {
            name: "read_file",
            description: "Read the text content of a file from the agent process. Relative paths resolve against the ACP session working directory. Large responses are truncated: pass offset (1-based start line) and limit (max lines, default 2000) to page through; the result reports the shown range and the total line count.",
            parameters: {
                type: "object",
                properties: {
                    path: {
        ...
        function: {
            ...
            parameters: {
                ...
                properties: {
                    command: {
                        type: "string",
                        description: "The shell command line to execute (interpreted by `sh -c`, so quoting, pipes, and redirects all work).",
                    },
                },
                required: ["command"],
            },
